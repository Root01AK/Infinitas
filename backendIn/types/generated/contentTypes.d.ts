...
export interface ApiAboutUsAboutUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    AboutExperience: Schema.Attribute.Component<
      'experienc-infinitas.experience',
      true
    >;
    ...
    OurValues: Schema.Attribute.Component<'values-list.our-values', true>;
    publishedAt: Schema.Attribute.DateTime;
    secDescription: Schema.Attribute.Text;
    secTitle: Schema.Attribute.String;
...
export interface ApiCareerCareer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    BannerCta: Schema.Attribute.String;
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ContactTitle: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Faqstitle: Schema.Attribute.Component<'faqs.faq-title', true>;
...
export interface ApiExpertisesExpertises extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    CaseStudy: Schema.Attribute.Component<'card.casestudy-card', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ExpertiseDescription: Schema.Attribute.Text;
    ExpertiseTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::expertises.expertises'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    SEO: Schema.Attribute.Component<'shared.seo', true>;
...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    BrandTitle: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTA: Schema.Attribute.Component<'list.cta', true>;
    Est: Schema.Attribute.String;
    EstBranding: Schema.Attribute.Text;
    EstBrandingline1: Schema.Attribute.String;
    EstDescription: Schema.Attribute.Text;
    EstHelpText: Schema.Attribute.String;
    EstTitle: Schema.Attribute.Text;
    Estyear: Schema.Attribute.String;
    geList: Schema.Attribute.Component<
      'listcontent.home-global-expertise',
      true
    >;
    geTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    OurMissionDescription: Schema.Attribute.Text;
    OurMissionImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    OurMissionTitle: Schema.Attribute.String;
    OurVisionDescription: Schema.Attribute.Text;
    OurVisionImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    ...
    TitleText1: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    SEO: Schema.Attribute.Component<'shared.seo', true>;
    Services: Schema.Attribute.Component<'services.sub-service', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    SEO: Schema.Attribute.Component<'shared.seo', true>;
    TeamList: Schema.Attribute.Component<'team-list.team', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::expertises.expertises': ApiExpertisesExpertises;
